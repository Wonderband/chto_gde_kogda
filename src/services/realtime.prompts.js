...
2. ОБОВ'ЯЗКОВО назви ім'я «${character}» і в ОДНІЙ фразі охарактеризуй персонажа театрально.
...
Оголоси сектор. ОБОВ'ЯЗКОВО назви ім'я «${character}» і в ОДНІЙ фразі охарактеризуй персонажа театрально.
